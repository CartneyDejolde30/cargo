...
Future<void> saveFcmToken() async {
  ...
  final url = Uri.parse("http://10.77.127.141/carGOAdmin/api/save_fcm_token.php");
...
void initState() {
  ...
  String formatImage(String? rawPath) {
    ...
    return "http://10.77.127.141/carGOAdmin/uploads/$cleanPath";
  }
  ...
  Future<String> resolveImageUrlCached(String? rawPath) async {
    ...
    if (path.startsWith("http://") || path.startsWith("https://")) {
      ...
      candidate = "http://10.77.127.141/carGOAdmin/uploads/$clean";
    }
  ...
  Future<void> fetchCars() async {
    final String apiUrl = "http://10.77.127.141/carGOAdmin/api/get_cars.php";
