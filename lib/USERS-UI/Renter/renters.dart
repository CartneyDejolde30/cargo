...
Future<void> saveFcmToken() async {
  ...
  final url = Uri.parse("http://172.24.58.180/carGOAdmin/api/save_fcm_token.php");
...
void initState() {
  ...
  String formatImage(String? rawPath) {
    ...
    return "http://172.24.58.180/carGOAdmin/uploads/$cleanPath";
  }
  ...
  Future<String> resolveImageUrlCached(String? rawPath) async {
    ...
    if (path.startsWith("http://") || path.startsWith("https://")) {
      ...
      candidate = "http://172.24.58.180/carGOAdmin/uploads/$clean";
    }
  ...
  Future<void> fetchCars() async {
    final String apiUrl = "http://172.24.58.180/carGOAdmin/api/get_cars.php";
