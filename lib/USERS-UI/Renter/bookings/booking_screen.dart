...
Future<void> _checkVerificationOnInit() async {
  ...
  try {
    final url = Uri.parse(
      "http://10.77.127.141/carGOAdmin/api/check_verification.php?user_id=${widget.userId}"
    );
...
Future<void> _submitBookingToServer() async {
  final url = Uri.parse("http://10.77.127.141/carGOAdmin/api/create_booking.php");
