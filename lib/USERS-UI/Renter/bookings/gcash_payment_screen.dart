...
class _GCashPaymentScreenState extends State<GCashPaymentScreen> {
  ...
  Future<void> _openQRScanner() async {
    ...
    if (result != null && result is String) {
      ...
      // For GCash InstaPay QR codes, extract relevant information
      setState(() {
        // You might need to parse the QR data based on GCash's format
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          _buildInstructionStep('1', 'Tap "Scan QR Code" button above'),
          _buildInstructionStep('2', 'Scan the GCash QR code provided'),
          _buildInstructionStep('3', 'Complete payment in GCash app'),
          _buildInstructionStep('4', 'Enter reference number and submit'),
        ],
      ),
    );
  }
