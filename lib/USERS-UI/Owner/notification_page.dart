...
class _NotificationPageState extends State<NotificationPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchNotifications({bool silent = false}) async {
    ...
    final url = Uri.parse(
        "http://172.24.58.180/carGOAdmin/get_notification.php?user_id=${widget.userId}");
  ...
  Future<void> archive(int id) async {
    try {
      await http.post(
        Uri.parse("http://172.24.58.180/carGOAdmin/archive_notification.php"),
        body: {"id": id.toString()},
  ...
  Future<void> markAllRead() async {
    try {
      await http.post(
        Uri.parse("http://172.24.58.180/carGOAdmin/update_all.php"),
