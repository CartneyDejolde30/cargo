...
class PendingRequestsPage extends StatelessWidget {
  ...
  final url = Uri.parse(
    "http://172.24.58.180/carGOAdmin/api/get_pending_requests.php?owner_id=$ownerId",
  );
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            ...
            final url = Uri.parse(
              "http://172.24.58.180/carGOAdmin/api/reject_request.php",
            );
...
Future<void> approveBooking(String bookingId, BuildContext context) async {
  final url = Uri.parse("http://172.24.58.180/carGOAdmin/api/approve_request.php");
